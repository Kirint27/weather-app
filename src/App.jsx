...
const App = () => {
  ...
  return (
    <main>
      ...
      <h3>
        Search for a location to view the weather over the next 5 days at 3 hour
        intervals
      </h3>
      <SearchBar setWeather={setWeather} setForecast={setForecast} setError={setError} /> {/* Pass state setters */}
